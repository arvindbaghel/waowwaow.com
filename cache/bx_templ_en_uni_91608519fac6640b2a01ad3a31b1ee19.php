...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
        ...
        <div class="adm-header">
        	<div class="adm-header-content">
            	<div class="adm-header-title bx-def-margin-sec-left">
                    ...
                    <img class="adm-header-logo" src="http://waowwaow.com/administration/templates/base/images/logo.png" />
                    ...
                    <!--
                        $(document).ready(function() {
                            $.get(
                                'http://waowwaow.com/get_rss_feed.php?ID=boonex_version&member=0', 
                                {},
                                function(sData) {
                                	if(!sData)
                                	    return;
    ...
    <?=$a['page_code_results'];?>
    <?=$a['page_code_installed'];?>
    <?=$a['page_code_not_installed'];?>
    <?=$a['page_code_updates'];?>
    <?=$a['page_code_uploader'];?>
	<?=$a['page_code_market_feed'];?>
